...
public class SourceSpan private constructor(
    ...
    public fun subSpan(beginIndex: Int): SourceSpan {
        return subSpan(beginIndex, length)
    }

    public fun subSpan(beginIndex: Int, endIndex: Int): SourceSpan {
    ...
    public companion object {
        public fun of(lineIndex: Int, columnIndex: Int, inputIndex: Int, length: Int): SourceSpan {
            return SourceSpan(lineIndex, columnIndex, inputIndex, length)
        }
    }
}
