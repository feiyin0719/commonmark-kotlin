...
/**
 * Runs the CommonMark spec test suite. Each example from spec.txt is parsed and rendered,
 * then compared against the expected HTML output.
 */
class SpecCoreTest {
    ...
    fun testSpecExamples() {
        ...
        if (failures.isNotEmpty()) {
            ...
            val message = buildString {
                appendLine("$passed/$total spec examples passed. ${failures.size} failures:")
                appendLine()
